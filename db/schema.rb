...
ActiveRecord::Schema[8.0].define(version: 2025_02_02_120520) do
  ...
  create_table "warranties", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_warranty_id"], name: "index_warranties_on_product_warranty_id"
  end

  add_foreign_key "product_categories", "categories"
  add_foreign_key "product_categories", "products"
  add_foreign_key "product_warranties", "products"
  add_foreign_key "warranties", "product_warranties"
end
